...
export type BusinessPageKey = Exclude<PageKey, 'customerProjects'>

export function BusinessPage({ page: currentPage }: { page: BusinessPageKey }) {
  ...
  // Customer project workflow remains in its dedicated lazy module.
  void customerProjectStatusOptions
  void filteredCustomerProjects
  void openCreateCustomerProject
  void resetCustomerProjectSearch
  void customerProjectColumns

  const pageMap: Record<BusinessPageKey, ReactNode> = {
